...
for data_name in all_data_name:
    ...
    cmd='trec_eval -q -m num_q -m num_ret -m num_rel -m num_rel_ret -m P.5,10,15,20,30,100 -m map_cut.10,100 -m ndcg_cut.10 %s %s > %s_results.txt'%('E:\\qrels-v2.txt','%s.runs'%(data_name),data_name)
    os.system(cmd)